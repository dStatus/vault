...
test('vault.readdir', async t => {
  var vault = new DWebVault(testStaticDWebURL, {dwebOptions: {latest: true}, localPath: tempy.directory()})
...
test('vault.readFile', async t => {
  ...
  var badVault = new DWebVault(fakeDWebURL, {dwebOptions: {latest: true}, localPath: tempy.directory()})
...
test('vault.createFileActivityStream', async t => {
  // create a fresh dweb
  var vault = await DWebVault.create({dwebOptions: {latest: true}, localPath: tempy.directory(), title: 'Another Test DWeb'})
...
test('vault.createNetworkActivityStream', async t => {
  ...
  var vault = new DWebVault(testStaticDWeb2URL, {dwebOptions: {latest: true}, localPath: tempy.directory()})
  await vault._loadPromise
